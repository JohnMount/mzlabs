...
We have translated these philosophic ramblings into a system that has greatly improved our productivity.   I have found that making it easier and more rewarding to work is much more effective than trying to develop "the discipline to work."  This is consistent with the theory that <a target="_blank" href="http://well.blogs.nytimes.com/2007/12/06/how-to-boost-your-willpower/">self control is a limited resource</a>.  This is also the flip size of <a target="_blank" href="http://www.win-vector.com/blog/2013/02/make-it-more-effort-to-do-the-wrong-thing/">Make it more effort to do the wrong thing</a>: make it even more pleasant to start creative work.
