...
For example: claiming "after we take over the world we will consider adding <a href="https://en.wikipedia.org/wiki/Universal_basic_income">Universal Basic Income (UBI)</a>". The LLM bros already a lot of the money, and they are not even rehearsing diverting it into basic income now. Why does one believe they would do that when they also have all of the power?</li>
</ul>
